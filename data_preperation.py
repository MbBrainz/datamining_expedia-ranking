...
from feature_engineering import convert_price_to_log, create_ranked_feature, drop_features_with_many_na, get_features_from_datetime, comp_inv_and_cheaper_count, create_price_difference, create_star_difference
...
#%%
train_df.to_csv("./data/processed_training_set_Vu_DM-v6.csv")
# %%
...
test_df.to_csv("./data/processed_test_set_VU_DM-v6.csv")
test_df.head()
# %%
